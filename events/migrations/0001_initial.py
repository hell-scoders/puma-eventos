    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address',
                 models.CharField(default='Ciudad Universitaria', max_length=100, verbose_name='Dirección del evento')),
                ...
                ('is_full_day',
                 models.BooleanField(default=False, verbose_name='El evento no tiene un horario definido')),
                ('image', models.ImageField(blank=True, null=True, upload_to='event_images/')),
                ('host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL,
                                           verbose_name='Persona o entidad que es host del evento')),
                ('parent_event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                   to='events.Event', verbose_name='Evento originario')),
            ],
        ),
        migrations.CreateModel(
            name='StaffEvent',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('day_of_week__gte', 1), ('day_of_week__lte', 7)),
                                              name='day_in_range'),
        ),
        migrations.AddConstraint(
            model_name='recurringpattern',
            constraint=models.CheckConstraint(check=models.Q(('week_of_month__gte', 1), ('week_of_month__lte', 5)),
                                              name='week_in_range'),
        ),
        migrations.AddConstraint(
            model_name='recurringpattern',
            constraint=models.CheckConstraint(check=models.Q(('month_of_year__gte', 1), ('month_of_year__lte', 12)),
                                              name='month_in_range'),
        ),
    ]
